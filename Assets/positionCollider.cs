...
public class positionCollider : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //Add the colliders
        topCollider.gameObject.AddComponent<BoxCollider2D>().sharedMaterial = PM;
        bottomCollider.gameObject.AddComponent<BoxCollider2D>().sharedMaterial = PM;
        rightCollider.gameObject.AddComponent<BoxCollider2D>().sharedMaterial = PM;
        leftCollider.gameObject.AddComponent<BoxCollider2D>().sharedMaterial = PM;
